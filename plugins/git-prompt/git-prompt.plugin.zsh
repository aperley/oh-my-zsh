...
git_super_status() {
    ...
    if [ -n "$__CURRENT_GIT_STATUS" ]; then
      ...
      elif [ "$GIT_STAGED" -ne "0" ] && [ "$GIT_CHANGED" -ne "0" ]; then
          STATUS="$STATUS$ZSH_THEME_GIT_PROMPT_STAGED_AND_CHANGED%{${reset_color}%}"
...
ZSH_THEME_GIT_PROMPT_STAGED_AND_CHANGED="%{$fg_bold[yellow]%}%{⦿%G%}"
